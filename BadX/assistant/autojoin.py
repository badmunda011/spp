...
@Client.on_message(
    filters.regex("↗️ Join All") & filters.private #& filters.user(TheBadX.sudo.sudoUsers)
)
...
@Client.on_message(
    filters.regex("Leave All ↙️") & filters.private #& filters.user(TheBadX.sudo.sudoUsers)
)
