...
def setupBadX():
    ...
    clear()
    print(f'    {white}BadX Version: v2.O \n    {white}By BadMundaX')
...
def get_start():
    clear(fast=True)
    confim = str(input(f"{ask}Wanna start BadX Now?: y/n: "))
    if confim.lower() == "y":
        os.system("pip3 install python-dotenv")
        os.system("python3 -m BadX")
    elif confim.lower() == "n":
        print(f"\n{info}Nevermind !! You Can Start It Later With by using; python3-m BadX\n")
        exit(2)
    else:
        os.system("clear")
